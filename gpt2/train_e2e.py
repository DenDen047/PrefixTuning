...
if __name__ == '__main__':
    ...
    parser.add_argument('--finetuned_model_path', type=str,
                        default='/workdir/data/transformers/examples/full/full/webnlgfinetune_n_20_act_ca'
    ...
    # Added by MX
    parser.add_argument('--cache_dir', type=str, default='/workdir/data/transformers/examples/control', help='cache dir')
    ...
    if args.mode == 'data2text':
        ...
        TRAIN_FILE = "/workdir/data/dart/data/v1.1.1/dart-v1.1.1-full-train.json"
        TEST_FILE = "/workdir/data/dart/data/v1.1.1/dart-v1.1.1-full-dev.json"
        ...
        # v2
        # TRAIN_FILE = "/workdir/data/webnlg-dataset/release_v2/json/webnlg_release_v2_train.json"
        # TEST_FILE =  "/workdir/data/webnlg-dataset/release_v2/json/webnlg_release_v2_dev.json"
        ...
        TRAIN_FILE = '/workdir/data/transformers/examples/seq2seq/cnn_dm/train.source'
        TEST_FILE = '/workdir/data/transformers/examples/seq2seq/cnn_dm/val.source'
        ...
        TRAIN_FILE = "/workdir/data/transformers/examples/seq2seq/xsum/train.source"
        TEST_FILE = "/workdir/data/transformers/examples/seq2seq/xsum/val.source"
    ...
    if load_prefix_model:
        LOAD_TRAIN_PREFIX = '/workdir/data/transformers/examples/control/med_topic_gen'
